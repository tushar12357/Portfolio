...
const TAB_DATA = [
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>Full Stack Web Development: HTML, CSS, JavaScript, ReactJS, Node.js, Express.js, MongoDB, Chart.js, RESTful APIs, React Native</li>
      ...
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-base lg:text-lg">
            ...
            HTML, CSS, and Git, I am continuously expanding my skill set. 
            A quick learner and a team player, I enjoy collaborating with other
            to create innovative, user-friendly applications across web and 
            mobile platforms.
          </p>
